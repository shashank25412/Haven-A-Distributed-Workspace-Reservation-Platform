/**
 * @file create_resource_command.hpp
 * @brief Defines the command for creating a new resource.
 */
...
/**
 * @brief Carries the input data required to create a new resource.
 */
class CreateResourceCommand final {
public:
    CreateResourceCommand(haven::domain::OrganizationId organization_id,
